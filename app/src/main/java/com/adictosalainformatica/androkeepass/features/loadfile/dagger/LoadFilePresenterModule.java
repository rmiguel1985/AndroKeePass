...
import com.adictosalainformatica.androkeepass.features.loadfile.presentation.presenter.impl.LoadFilePresenterImpl;
...
public class LoadFilePresenterModule {
    ...
    public LoadFilePresenter providesLoadFilePresenter(CreateDatabaseUseCase createDatabaseUseCase,
        ...
        return new LoadFilePresenterImpl(createDatabaseUseCase, getDatabasesUseCase, deleteDatabaseUseCase);
    }
}
